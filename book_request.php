...
if (isset($_POST['book_car'])) {
    ...
    $sql = "INSERT INTO orders (id, carid, confirm) VALUES ($id, $car_id, 1)";
...
$id = $user_data['id'];
$sql = "SELECT * FROM orders WHERE id = $id AND confirm = 1";
    ...
    <section class="book-requests">
        ...
        <ul>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<button type='submit' class='cancel-request' name='cancel_booking'>Cancel Request</button>";
                echo "</form>";
                echo "</div>";
                echo "</li>";
				}
